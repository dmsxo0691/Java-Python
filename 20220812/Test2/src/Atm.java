                    ...
                    case 1:
                        while (true) {
                            ...
                            for (int i = 0; i < GestList.length; i++) {
                                if (GestCount >= 5) {
                                    System.out.println("ID가 5개 이상되어 가입이 제한됩니다.");
                                    break;
                                }
                                    ...
                                    if (LoginPw != GestList[i].PW) {
                                        ...
                                        while (Login) {
                                            if (LoginId == GestList[i].ID) {
                                                ...
                                                System.out.println("=========== ATM MENU ===========");
                                                System.out.println(
                                                        "ID(" + GestList[i].ID + ")| " + GestList[i].Cash + "원");
                                                        ...
                                                        if (GestList[i].Cash == 0) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (currentDeposit < 0) {
                                                                    ...
                                                                    System.out.println(
                                                                            "(경고) 잔액보다 많은 금액을 출금할 수 없습니다.");
                                                                } else {
                                                                    GestList[i].Cash -= currentDeposit;
                                                                    System.out.println("출금이 완료되었습니다.");
                                                                    System.out.println(
                                                                            "\n현재 잔액: " + GestList[i].Cash
                                                                                    + "원 \n");
                                                                    break;
                                                                }
                                                            } // while 끝
                                                    ...
                                                    case 3:
                                                        ...
                                                        for (int j = 0; j < GestList.length; i++) {
                                                            if (transId == GestList[j].ID) {
                                                                ...
                                                                System.out.println("[메세지]현 계좌에는 " + GestList[i].Cash
                                                                        + "원이 있습니다.");
                                                                System.out.println("[메세지]입금된 계좌에는 "
                                                                        + GestList[j].Cash + "원이 있습니다.");
                                                                break;
                                                            }
